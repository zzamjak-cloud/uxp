...
document.getElementById("prefixf").addEventListener("click", () => {renamerLayers("_F_")});
document.getElementById("prefixb").addEventListener("click", () => {renamerLayers("_B_")});
document.getElementById("prefixr").addEventListener("click", () => {renamerLayers("_R_")});
document.getElementById("prefixl").addEventListener("click", () => {renamerLayers("_L_")});
